...
const Home = () => {
  ...
  return (
    <div className="bg-gray-950 min-h-scren">
      <div className="container-app">
        <section className="py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Gerencie suas finanças com o <span className="text-primary-500">DevLBills</span>
              </h1>
        ...
        <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
          <div className="container-app">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">Recursos do DevLBills</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature) => (
                <div key={feature.title} className="bg-gray-800 p-6 rounder-xl hover:shadow-lg">
                  ...
                  <h3 className="text-cl font-semibold text-shite mb-2">{feature.title}</h3>
